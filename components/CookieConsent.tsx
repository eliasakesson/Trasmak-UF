...
function CookiePopup({
	...
	return (
		<motion.div
			className="fixed bottom-8 left-16 right-16 z-50 lg:left-1/2 lg:right-auto"
			initial={{ translateY: "100%" }}
			animate={{ translateY: 0 }}
		>
			<div className="z-50 flex flex-col gap-2 rounded-lg border-2 bg-primary_light p-4 lg:-translate-x-1/2 lg:p-8">
				...
				<p className="max-w-prose text-xs text-gray-200">
				...
				<div className="mt-2 flex flex-col gap-2 md:flex-row">
					<button
						onClick={onAccept}
						className="w-full rounded-lg bg-white px-4 py-3 font-semibold transition-colors lg:w-fit 2xl:px-8"
					>
						Acceptera
					</button>
					<button
						onClick={onSettings}
						className="w-full rounded-lg font-semibold text-white transition-colors hover:bg-slate-200 hover:bg-opacity-10 lg:w-fit 2xl:px-8"
					>
						Inställningar
					</button>
				</div>
