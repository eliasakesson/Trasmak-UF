	...
	return (
		<section className="min-h-[75vh] w-full flex lg:flex-row flex-col-reverse lg:justify-between items-center relative py-8">
			<div className="sm:space-y-8 space-y-4 max-w-prose py-8">
				<h1 className="md:text-7xl sm:text-5xl text-4xl font-bold leading-tight text-gray-900">
				...
				<p className="sm:text-xl text-base text-gray-600 max-w-full">
					...
					tillverkade med omsorg och precision i Sverige. Ge ditt hem
					eller företag en unik touch med våra skräddarsydda designs.
				</p>
				<br />
			...
			<div className="flex flex-col items-end -space-y-8">
				<motion.div
					...
					<div className="xl:h-56 lg:h-40 sm:h-32 h-24 aspect-video bg-amber-700 border-amber-600 border-8 rounded-xl sm:p-6 p-3 flex flex-col items-center justify-center">
