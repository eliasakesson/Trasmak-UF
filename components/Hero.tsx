...
export default function Hero() {
	...
	return (
		<section className="lg:min-h-[calc(100vh-153px)] min-h-[calc(100vh-111px)] flex max-lg:flex-col-reverse max-lg:gap-8">
			<div className="lg:flex-1 flex max-lg:h-1/2">
				<div className="lg:pl-[10vw] lg:pr-[5vw] px-8 lg:pb-[153px] pb-8 flex flex-col justify-center gap-8 h-full">
